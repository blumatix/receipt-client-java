...
public class ApiClient {
    ...
    private String basePath = "https://capture.bludelta.ai/receipt";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://capture.bludelta.ai/receipt",
      "Production server",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://capture.bludelta.ai/receipt
    ...
    public RequestBody buildRequestBodyMultipart(Map<String, Object> formParams) {
        ...
        for (Entry<String, Object> param : formParams.entrySet()) {
            ...
            } else if (param.getValue()  instanceof FileData) {
                FileData fileData = (FileData) param.getValue();
                addPartToMultiPartBuilder(mpBuilder, param.getKey(), fileData);
            } else {
    ...
    private void addPartToMultiPartBuilder(MultipartBody.Builder mpBuilder, String key, FileData fileData) {
        MediaType mediaType = MediaType.parse(fileData.getContentType());
        RequestBody requestBody = RequestBody.create(fileData.getData(), mediaType);
        Headers partHeaders = Headers.of("Content-Disposition", "form-data; name=\"" + key + "\"; filename=\"" + fileData.getFileName() + "\"");
